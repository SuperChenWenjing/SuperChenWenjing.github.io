...
<p class="paragraph">陈文景 is handsome!</p>
<p id="par">陈文景 is very handsome!</p>
```
...
```html
<p>陈文景 很帅！</p>
<p class="bold">陈文景 is handsome!</p>
<p class="bold center">陈文景 is handsome!</p>
<p class="center">陈文景 is handsome!</p>
```
