...
</code></pre><div class="language-javascript" data-ext="js" data-title="js"><pre class="language-javascript"><code><span class="token keyword">if</span> <span class="token punctuation">(</span>布尔值<span class="token punctuation">)</span>
...
</code></pre></div><p>由于 <code>age</code> 的值为 <code>20</code>，它实际上同时满足条件 <code>age &gt;= 6</code> 和 <code>age &gt;= 18</code> ，这说明条件判断的顺序非常重要。请修复后让其显示 <code>&#39;adult&#39;</code>。</p><p>:::</p>`,53);function u(r,d){return e(),t("div",null,[l,p(" more "),i])}const v=a(c,[["render",u],["__file","condition.html.vue"]]),m=JSON.parse('{"path":"/casual/code/language/js/guide/condition.html","title":"条件判断","lang":"zh-CN","frontmatter":{"title":"条件判断","icon":"condition","date":"2019-09-16T00:00:00.000Z","category":"JavaScript","tag":["快速上手"],"description":"JavaScript 提供 if 结构和 switch 结构，完成条件判断，即只有满足预设的条件，才会执行相应的语句。 if if 结构 if 结构先判断一个表达式的布尔值，然后根据布尔值的真伪^truefalse，执行不同的语句。 上面是 if 结构的基本形式。需要注意的是，“布尔值”往往由一个条件表达式产生的，必须放在圆括号中，表示对表达式求值。如...","head":[["meta",{"property":"og:url","content":"https://SuperChenWenjing.github.io/casual/code/language/js/guide/condition.html"}],["meta",{"property":"og:site_name","content":"陈文景"}],["meta",{"property":"og:title","content":"条件判断"}],["meta",{"property":"og:description","content":"JavaScript 提供 if 结构和 switch 结构，完成条件判断，即只有满足预设的条件，才会执行相应的语句。 if if 结构 if 结构先判断一个表达式的布尔值，然后根据布尔值的真伪^truefalse，执行不同的语句。 上面是 if 结构的基本形式。需要注意的是，“布尔值”往往由一个条件表达式产生的，必须放在圆括号中，表示对表达式求值。如..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-03-08T16:03:07.000Z"}],["meta",{"property":"article:author","content":"陈文景"}],["meta",{"property":"article:tag","content":"快速上手"}],["meta",{"property":"article:published_time","content":"2019-09-16T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-03-08T16:03:07.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"条件判断\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2019-09-16T00:00:00.000Z\\",\\"dateModified\\":\\"2024-03-08T16:03:07.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"陈文景\\",\\"email\\":\\"2646530197@qq.com\\",\\"url\\":\\"https://superchenwenjing.github.io\\"}]}"]]},"headers":[{"level":2,"title":"if","slug":"if","link":"#if","children":[{"level":3,"title":"if 结构","slug":"if-结构","link":"#if-结构","children":[]},{"level":3,"title":"if...else 结构","slug":"if-else-结构","link":"#if-else-结构","children":[]},{"level":3,"title":"多行条件判断","slug":"多行条件判断","link":"#多行条件判断","children":[]}]},{"level":2,"title":"switch 结构","slug":"switch-结构","link":"#switch-结构","children":[]},{"level":2,"title":"? : 三元运算符","slug":"三元运算符","link":"#三元运算符","children":[]},{"level":2,"title":"章节问题","slug":"章节问题","link":"#章节问题","children":[]}],"git":{"createdTime":1709913787000,"updatedTime":1709913787000,"contributors":[{"name":"陈文景","email":"2646530197@qq.com","commits":1}]},"readingTime":{"minutes":6.09,"words":1827},"filePathRelative":"casual/code/language/js/guide/condition.md","localizedDate":"2019年9月16日","excerpt":"<p>JavaScript 提供 <code>if</code> 结构和 <code>switch</code> 结构，完成条件判断，即只有满足预设的条件，才会执行相应的语句。</p>\\n","autoDesc":true}');export{v as comp,m as data};
