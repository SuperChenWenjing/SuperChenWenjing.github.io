...
</code></pre></div><p>切换回 master 分支后，再查看一个 <code>readme.txt</code> 文件，刚才添加的内容不见了! 因为那个提交是在 dev 分支上，而 master 分支此刻的提交点并没有变:</p><p><img src="`+d+`" alt="示例图" loading="lazy"></p><p>现在，我们把 dev 分支的工作成果合并到 master 分支上:</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ <span class="token function">git</span> merge dev
...
</code></pre></div><p>现在，<code>master</code> 分支和 <code>feature1</code> 分支各自都分别有新的提交，变成了这样:</p><p><img src="`+r+`" alt="示例图" loading="lazy"></p><p>这种情况下，Git 无法执行“快速合并”，只能试图把各自的修改合并起来，但这种合并就可能会有冲突，我们试试看:</p><div class="language-bash" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ <span class="token function">git</span> merge feature1
...
</code></pre></div><p>现在，<code>master</code> 分支和 <code>feature1</code> 分支变成了下图所示:</p><p><img src="`+u+`" alt="示例图" loading="lazy"></p><p>用带参数的 <code>git log</code> 也可以看到分支的合并情况:</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ <span class="token function">git</span> log <span class="token parameter variable">--graph</span> <span class="token parameter variable">--pretty</span><span class="token operator">=</span>oneline --abbrev-commit
...
</code></pre></div><p>可以看到，不使用 <code>Fast forward</code> 模式，<code>merge</code> 后就像这样:</p><p><img src="`+m+`" alt="示例图" loading="lazy"></p><h3 id="分支管理惯例" tabindex="-1"><a class="header-anchor" href="#分支管理惯例"><span>分支管理惯例</span></a></h3><p>在实际开发中，我们应该按照几个基本原则进行分支管理:</p><p>首先，<code>master</code> 分支应该是非常稳定的，也就是仅用来发布新版本，平时不能在上面干活；</p><p>那在哪干活呢? 干活都在 <code>dev</code> 分支上，也就是说，<code>dev</code> 分支是不稳定的，到某个时候，比如 <code>1.0</code> 版本发布时，再把 <code>dev</code> 分支合并到 <code>master</code> 上，在 <code>master</code> 分支发布 <code>1.0</code> 版本；</p><p>您和您的小伙伴们每个人都在 <code>dev</code> 分支上干活，每个人都有自己的分支，时不时地往 <code>dev</code> 分支上合并就可以了。</p><p>所以，团队合作的分支看起来就像这样:</p><div class="language-git-graph line-numbers-mode" data-ext="git-graph" data-title="git-graph"><pre class="language-git-graph"><code>commit
branch hotfix
checkout hotfix
commit
branch develop
...
* d1be385 init hello
<span class="token punctuation">..</span>.
</code></pre></div><p>远程分支的提交历史也是一条直线。</p><h2 id="rebase-小结" tabindex="-1"><a class="header-anchor" href="#rebase-小结"><span>Rebase 小结</span></a></h2><ul><li><p><code>rebase</code> 操作可以把本地未 <code>push</code> 的分叉提交历史整理成直线；</p></li><li><p><code>rebase</code> 的目的是使得我们在查看历史提交的变化时更容易，因为分叉的提交需要三方对比。</p></li></ul>`,246),b=[v];function k(h,f){return a(),s("div",null,b)}const w=n(g,[["render",k],["__file","branch.html.vue"]]),y=JSON.parse('{"path":"/software/git/branch.html","title":"分支管理","lang":"zh-CN","frontmatter":{"date":"2020-05-04T00:00:00.000Z","title":"分支管理","icon":"branch","order":10,"author":"廖雪峰","category":"Git","tag":["Git","软件"],"copyright":"Copyright by 廖雪峰 Edited by 陈文景","description":"概述 分支就是科幻电影里面的平行宇宙，当您正在电脑前努力学习 Git 的时候，另一个您正在另一个平行宇宙里努力学习 SVN。 如果两个平行宇宙互不干扰，那对现在的您也没啥影响。不过，在某个时间点，两个平行宇宙合并了，结果，您既学会了 Git 又学会了 SVN! Learn branches 分支在实际中有什么用呢? 假设您准备开发一个新功能，但是需要两...","head":[["meta",{"property":"og:url","content":"https://SuperChenWenjing.github.io/software/git/branch.html"}],["meta",{"property":"og:site_name","content":"陈文景"}],["meta",{"property":"og:title","content":"分支管理"}],["meta",{"property":"og:description","content":"概述 分支就是科幻电影里面的平行宇宙，当您正在电脑前努力学习 Git 的时候，另一个您正在另一个平行宇宙里努力学习 SVN。 如果两个平行宇宙互不干扰，那对现在的您也没啥影响。不过，在某个时间点，两个平行宇宙合并了，结果，您既学会了 Git 又学会了 SVN! Learn branches 分支在实际中有什么用呢? 假设您准备开发一个新功能，但是需要两..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-03-08T16:03:07.000Z"}],["meta",{"property":"article:author","content":"廖雪峰"}],["meta",{"property":"article:tag","content":"Git"}],["meta",{"property":"article:tag","content":"软件"}],["meta",{"property":"article:published_time","content":"2020-05-04T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-03-08T16:03:07.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"分支管理\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2020-05-04T00:00:00.000Z\\",\\"dateModified\\":\\"2024-03-08T16:03:07.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"廖雪峰\\"}]}"]]},"headers":[{"level":2,"title":"概述","slug":"概述","link":"#概述","children":[]},{"level":2,"title":"创建与合并分支","slug":"创建与合并分支","link":"#创建与合并分支","children":[{"level":3,"title":"分支小结","slug":"分支小结","link":"#分支小结","children":[]}]},{"level":2,"title":"冲突","slug":"冲突","link":"#冲突","children":[{"level":3,"title":"冲突小结","slug":"冲突小结","link":"#冲突小结","children":[]}]},{"level":2,"title":"分支管理策略","slug":"分支管理策略","link":"#分支管理策略","children":[{"level":3,"title":"分支管理惯例","slug":"分支管理惯例","link":"#分支管理惯例","children":[]},{"level":3,"title":"分支管理小结","slug":"分支管理小结","link":"#分支管理小结","children":[]}]},{"level":2,"title":"Bug 分支","slug":"bug-分支","link":"#bug-分支","children":[{"level":3,"title":"暂存小结","slug":"暂存小结","link":"#暂存小结","children":[]}]},{"level":2,"title":"Feature 分支","slug":"feature-分支","link":"#feature-分支","children":[{"level":3,"title":"删除小结","slug":"删除小结","link":"#删除小结","children":[]}]},{"level":2,"title":"多人协作","slug":"多人协作","link":"#多人协作","children":[{"level":3,"title":"推送分支","slug":"推送分支","link":"#推送分支","children":[]},{"level":3,"title":"抓取分支","slug":"抓取分支","link":"#抓取分支","children":[]},{"level":3,"title":"多人协作小结","slug":"多人协作小结","link":"#多人协作小结","children":[]}]},{"level":2,"title":"Rebase","slug":"rebase","link":"#rebase","children":[]},{"level":2,"title":"Rebase 小结","slug":"rebase-小结","link":"#rebase-小结","children":[]}],"git":{"createdTime":1709913787000,"updatedTime":1709913787000,"contributors":[{"name":"陈文景","email":"2646530197@qq.com","commits":1}]},"readingTime":{"minutes":22.93,"words":6880},"filePathRelative":"software/git/branch.md","localizedDate":"2020年5月4日","excerpt":"","autoDesc":true}');export{w as comp,y as data};
